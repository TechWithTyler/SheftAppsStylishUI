...
///
/// Fun fact: This component was introduced to SheftAppsStylishUI on RandoFacto's 1-year development anniversary, 11/21/23!
public struct TranslucentFooterVStack<MainContent: View, FooterContent: View>: View {
    ...
    public var body: some View {
        if #available(macOS 26, iOS 26, watchOS 26, tvOS 26, *), usesLiquidGlass {
            ...
            #else
            contentWithRegularTranslucentFooter
            #endif
        } else {
            contentWithRegularTranslucentFooter
        }
    ...
    // MARK: - Regular Translucent Footer

    @ViewBuilder
    var contentWithRegularTranslucentFooter: some View {
        mainContentStack
